function [dOmegaByDt, domegaByDt] = orbitalPerturbationRates(mu, R0, J2, a, e, i)
...
dOmegaByDt = -3 * rad * n * J2 * R0^2 * cosd(i) / ( 2 * a^2 * (1 - e^2)^2 ) ;
domegaByDt = 3 * rad * n * J2 * R0^2 * (4 - 5 * sind(i)^2) / ( 4 * a^2 * (1 - e^2)^2 );
